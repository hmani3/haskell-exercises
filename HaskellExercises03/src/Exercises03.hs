...
exTree :: Tree Char
exTree = Node 'd' 
        (Node 'b' (Leaf 'a') (Leaf 'c')) -- Branch 1
        (Node 'f' (Leaf 'e') (Leaf 'g')) -- Branch 2
...
-----------------------------------------------------------------------------------------------------------
greaterThanEqual :: Ord a => a -> Tree a -> Bool
greaterThanEqual n (Leaf m)       = n >= m
greaterThanEqual n (Node m t0 t1) = n >= m 
                                  && greaterThanEqual n t0 
                                  && greaterThanEqual n t1

lessThan :: Ord a => a -> Tree a -> Bool
lessThan n (Leaf m)       = n < m
lessThan n (Node m t0 t1) = n < m 
                          && lessThan n t0 
                          && lessThan n t1

isSearchTree :: Ord a => Tree a -> Bool
isSearchTree (Leaf _)       = True
isSearchTree (Node v t0 t1) = greaterThanEqual v t0 
                            && lessThan v t1 
                            && isSearchTree t0 
                            && isSearchTree t1
